...
namespace CPL
{
    ...
    public:
        ...
        // Calculate the mean across a certain axis and replace all values with
        // it
        //void averageAlongAxis (const int axis);
    ...
    private:
        ...
        // Exceptions
        //class wrongShape shapeEx;
        //class invalidOrder orderEx;
